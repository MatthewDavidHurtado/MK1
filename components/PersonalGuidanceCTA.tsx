...
const PersonalGuidanceCTA: React.FC = () => {
  return (
    <div className="mt-10 mb-6 p-6 bg-amber-50/70 border border-amber-200 rounded-lg shadow-lg app-sans-serif text-center">
      <h2 className="text-2xl font-semibold text-amber-700 mb-3">
        Seeking Deeper, Personalized Divine Law Treatment?
      </h2>
      <p className="text-amber-900 leading-relaxed mb-4 text-justify md:text-center">
